...
//    config.wired_sync_mode = K4A_WIRED_SYNC_MODE_MASTER;		// the sync-mode of mutli-device, the device is master.
    ...
    config.depth_delay_off_color_usec = -320;
    ...
    string chosenUserNum = "sideLow_" + chosenUserNumber.toStdString();		// Modify string according to camera position. sideLow_, side_
    ...
    else
    {
        ...
        mkvName = mkvPath + "sideLow_" + YMDHMS_timestamp + ".mkv";
    }
