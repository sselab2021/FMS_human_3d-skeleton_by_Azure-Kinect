...
//    config.wired_sync_mode = K4A_WIRED_SYNC_MODE_MASTER;		// the sync-mode of mutli-device, the device is master.
    ...
    string chosenUserNum = "side_" + chosenUserNumber.toStdString();		// Modify string according to camera position. side_, side_
    ...
    else
    {
        ...
        mkvName = mkvPath + "side_" + YMDHMS_timestamp + ".mkv";
    }
