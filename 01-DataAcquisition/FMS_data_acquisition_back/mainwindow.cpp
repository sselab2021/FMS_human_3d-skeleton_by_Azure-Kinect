...
//    config.wired_sync_mode = K4A_WIRED_SYNC_MODE_MASTER;		// the sync-mode of mutli-device, the device is master.
    ...
    string chosenUserNum = "back_" + chosenUserNumber.toStdString();		// Modify string according to camera position. back_, side_
    ...
    else
    {
        ...
        mkvName = mkvPath + "back_" + YMDHMS_timestamp + ".mkv";
    }
